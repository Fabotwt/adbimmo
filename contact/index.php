...
<body>
				...
				<div class="col-lg-8 col-md-12">
					<div class="contact-box">
						<div class="contact-box-title">
							...
							<p>Vous avez des questions, des commentaires ou besoin d'informations supplémentaires ? 
								N'hésitez pas à nous contacter. Notre équipe est là pour vous aider et répondre à 
								toutes vos demandes. 
								Remplissez simplement le formulaire ci-dessous et nous vous répondrons dans 
						...
						<form action="https://formspree.io/f/myyleorq" method="POST" id="it-form">
							<div class="row">
								...
								<div class="col-lg-12">
									<div class="form-box">
										<input type="text" name="name" placeholder="Nom de votre Entreprise">
									</div>
								</div>
								<div class="col-lg-12 col-md-12">
									<div class="form-box">
										<textarea name="massage" id="massage" cols="30" rows="10" placeholder="Écrivez votre question ici"></textarea>
									</div>
								</div>
								<div class="col-lg-12 col-md-12">
	...
	<div class="map-area">
		<div class="container-fluid p-0">
			<div class="row">
				<div class="col-lg-12 col-md-12">
				<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d15861.12410412843!2d2.3805295943359495!3d6.357659034203041!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sfr!2sbj!4v1711471544884!5m2!1sfr!2sbj" width="1920" height="608" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
				</div>
			</div>
		</div>
	</div>
