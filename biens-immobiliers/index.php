			...
			<div class="row">
				<div class="col-lg-12 col-md-12">
					<div class="service-details-title">
						<h4>Découvrez Nos Biens Immobiliers</h4>
					</div>
					<div class="service-detials-discription">
						
						<p>
						Bienvenue dans notre catalogue de biens immobiliers. Que vous soyez à la recherche d'une maison, d'un appartement, d'un local commercial ou d'un terrain, nous avons une sélection diversifiée de propriétés qui pourraient correspondre à vos besoins et à vos préférences.
						</p>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="section-title text-center">
						...
						<div class="section-sub-titile testi">
							<h4>Nos biens en portefeuille</h4>
						</div>
						<div class="section-sub-thumb">
							<img src="assets/images/resource/s-title-shape.png" alt="">
						</div>
						<div class="section-main-title testi">
							<h2>Explorez Nos Biens Immobiliers</h2>
						</div>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="catagori-search-box">
					<div class="catagori-search-title">
						...
						<form method="GET">
							<div class="row">
								...
								<div class="col-lg-3 col-md-6">
									...
									<div class="form-group">
										<select class="selectpicker search-fields" name="Category Area">
						...
						<div class="service-single-box">
							<div class="service-thumb">
								...
								<div class="service-rate">
									<h4>120 000 FCFA<span>/Mois</span></h4>
								</div>
							</div>
							<div class="service-content">
								<div class="service-titile">
									<h4><a href="#">Nouvel appartement avec belle vue</a></h4>
								</div>
								<div class="service-discription">
									<p>conçue pour offrir le plus haut niveau de confort et de commodité, avec des équipements 
										tels que des espaces lumineux, des salles de bains élégantes et des garages sécurisés.</p>
								</div>
